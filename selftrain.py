...
class_name = ["Aim","Email","Facebook","Gmail","Hangout","Icq","Netflix",
              "Scpdown","Sftpdown","Skype","Spotify","Tottwitter","Vimeo","Voipbuster","Youtube","Voip"]
...
def pre(load_model):
    ...
    for i in range(int(batch_size/10)):
        ...
        if(count.empty==False and number.max() > 3 ):
...
if __name__ == '__main__':
    ...
    load_model = load_model('I:\dataSet/test_model_unknow.h5')

    path = 'I:\dataSet/resultB/test/003Voip.tfrecord'
